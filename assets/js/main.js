...
// function addTocart-items(productName, productPrice, productImg) {
  
//   let cart-items = localStorage.getItem("cart-items");
//   if (cart-items) {
...
//   cart-items.push({ name: productName, price: productPrice, img: productImg });
